...
public class RadioPhonk implements RocketBotCommand {
    @Override
    ...
    public String getDescription() {
        return "Phonk music for Misha Aleshin";
    }
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        try(Connection connection = DriverManager.getConnection(jdbcUrl);
            ...
            String sql = "SELECT link FROM tracks WHERE type = 'phonk'";
        ...
        event.reply("PHONK loaded").setEphemeral(true).queue();
    }
}
