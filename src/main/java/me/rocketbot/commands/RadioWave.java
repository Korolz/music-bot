...
public class RadioWave implements RocketBotCommand {
    @Override
    ...
    public String getDescription() {
        return "Electronic music(DnB, House, etc.)";
    }
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        try(Connection connection = DriverManager.getConnection(jdbcUrl);
            ...
            String sql = "SELECT link FROM tracks WHERE type = 'wave'";
        ...
        event.reply("WAVE loaded").setEphemeral(true).queue();
    }
}
