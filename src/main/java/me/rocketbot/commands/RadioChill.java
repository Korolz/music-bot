...
public class RadioChill implements RocketBotCommand {
    @Override
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        try(Connection connection = DriverManager.getConnection(jdbcUrl);
            ...
            String sql = "SELECT link FROM tracks WHERE type = 'chill'";
        ...
        event.reply("CHILL loaded").setEphemeral(true).queue();
    }
}
